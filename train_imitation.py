        ...
        for batch in tqdm(dataloader):
            ...
            if is_tree:
                ...
                batched_states = (batch.constraint_features, batch.edge_index[0], batch.edge_index[1],
                                ...
                                tree_features, batch.candidates, batch.nb_candidates)
            else:
...
def train(problem = "setcover", model_name = "tree"):
    ...
    load_model = None
    # load_model = "checkpoints/setcover/20210718_1323/setcover_best_120.pt"
    ...
    for epoch in range(NB_EPOCHS):
        ...
        if epoch % 1 == 0:
            log_values(valid_acc, valid_loss, val_kacc, epoch, log_path, problem)
